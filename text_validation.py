...
query_dict = read_query_xml_to_dict(
    '/lv_local/home/niv.b/content_modification_code-master/data/queries_bot_modified_sorted_1.xml')
new_query_dict = {}
comp_dict = {}
...
create_query_xml(new_query_dict,
                 f'/lv_local/home/niv.b/content_modification_code-master/data/query_files/queries_{cp}.xml')
